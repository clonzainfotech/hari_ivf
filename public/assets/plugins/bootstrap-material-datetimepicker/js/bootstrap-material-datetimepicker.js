   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<button class="dtp-btn-clear  btn btn-primary btn-flat hidden">' + this.params.clearText + '</button>' +
                         '<button class="dtp-btn-cancel btn btn-primary btn-flat">' + this.params.cancelText + '</button>' +
