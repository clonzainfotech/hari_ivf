...
$.AdminOreo = {}, $.AdminOreo.options = {
    ...
    activate: function() {
        ...
        $(window).on("click", function(e) {
            var a = $(e.target);
            "i" === e.target.nodeName.toLowerCase() && (a = $(e.target).parent()), !a.hasClass("bars") && t.isOpen() && 0 === a.parents("#leftsidebar").length && (a.hasClass("js-right-sidebar") || o.fadeOut(), i.removeClass("overlay-open"))
    ...
    activate: function() {
        ...
        $(window).on("click", function(e) {
            var a = $(e.target);
            "i" === e.target.nodeName.toLowerCase() && (a = $(e.target).parent()), !a.hasClass("js-right-sidebar") && t.isOpen() && 0 === a.parents("#rightsidebar").length && (a.hasClass("bars") || o.fadeOut(), i.removeClass("open"))
        }), $(".js-right-sidebar").on("click", function() {
            i.toggleClass("open"), t.isOpen() ? o.fadeIn() : o.fadeOut()
        })
    },
    isOpen: function() {
