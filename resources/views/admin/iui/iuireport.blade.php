            ...
            <div class="body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    {{Form::text("data[simulation][trigger][date]",cdate(!empty($iuiReportdata->simulation->trigger->date) ? $iuiReportdata->simulation->trigger->date : null)->format('D d M Y'),['class'=>'form-control datetimepicker triggerdate'])}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            {{Form::text("data[simulation][sp2date]",cdate($iuiReportdata->simulation->sp2date ? $iuiReportdata->simulation->sp2date : $lastAppointmentData->date)->format('D d M Y'),['class'=>'form-control datetimepicker sp2date'])}}
                        </div>
                        <span class="form-error-msg">
                ...
                <div class="row">
                    <div class="col-md-6">
                            <div class="input-group">
                                <span class="input-group-addon col-md-2">Date : &nbsp;</span>
                                {{Form::text("data[ovum][date]",cdate(!empty($iuiReportdata->ovum->date) ? $iuiReportdata->ovum->date : null)->format('D d M Y'),['class'=>'form-control datetimepicker ovumdate'])}}
                            </div>
                            <span class="form-error-msg">
