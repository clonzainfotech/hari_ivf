                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="radio is-conceived">
                                                    ...
                                                    {{Form::radio("oh[child][child_data][".$key."][ho_type]",'cesarean',!empty($row->ho_type_value) && $row->ho_type_value == 'cesarean' ? true : false,['id'=>'cesarean_'.$key])}}
                                                    <label for={{'cesarean_'.$key}}>
                                                        Cesarean
                                                    </label>

                                                    {{Form::radio("oh[child][child_data][".$key."][ho_type]",'instrumental',!empty($row->ho_type_value) && $row->ho_type_value == 'instrumental' ? true : false,['id'=>'instrumental_'.$key])}}
                        ...
                        <div class="panel-body" id="parent">
                            <div class="row treatment-data" id="t_data_1">
                                ...
                                <div class="col-md-8 complain-multi mb-3 medicine-picker">
                                    {{Form::select('treatment[medicinedata][]',$medicines,$medicineKey,['id'=>'treatment-medicine','class'=>'form-control co-value medicine medicine-co','placeholder'=>'Enter medicine name'])}}
                                </div>
                            </div>
