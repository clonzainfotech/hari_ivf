                ...
                <div class="body">
                    ...
                    <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-2">{{Form::select('hcg',['1'=>'Yes','2'=>'No'],'',['class'=>'hcg-type select-padding-0 w-100','placeholder'=>'Select HCG Type'])}}</div>
                                <div class="col-md-3">
                                    <form method="post" autocomplete="off" action="">
...
@section('page-script')
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $(document).on('dblclick', '#appointment-table tbody tr', function(event) {
                ...
                if(typeof(patientsId) !== 'undefined'){
                        type = 'create';
                    if($(this).hasClass('iui')){
                        type = 'history';
                    }
                    var url = "{{URL::to('iui')}}"+'/'+type+'/'+patientsId;
                    window.location.href=url;
                }
            });

            $(document).on('click', '.print-iui', function () {
                qstring = 'page='+page+'&patient_id='+patientId+'&date='+date+'&hcg='+hcg+'&search='+search+'&isprint=1';
                getIuiData(qstring);
            });
        });
        ...
        function getIuiData(qstring){
            ...
            $.ajax({
                url: "{{URL::to('iui')}}?"+qstring,
                dataType: 'json',
            }).done(function(data) {
                if(data.status == 1){
                    $('.iui-data').html(data.iui);
