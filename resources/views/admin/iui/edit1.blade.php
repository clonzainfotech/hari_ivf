            ...
            @if($visitNo == 2)
                ...
                <div class="row">
                    ...
                    <div class="{{'col-md-5 ivf-plans '.$ivf_plan_status}}">
                        <div class="form-group">
                            {{Form::select("data[ivf_plan]",['1'=>'Self','2'=>'FET','3'=>'FET-OD','4'=>'FET-ED'],isset($historyData->ivf_plan) && !empty($historyData->ivf_plan) ? $historyData->ivf_plan :null,['class'=>'form-control select-padding-0 ivf-transfer-plan','placeholder'=>'select IVF Plan',!empty($historyData->ivf) && $historyData->ivf == 'yes' ? 'disabled' : ''])}}
                        </div>
