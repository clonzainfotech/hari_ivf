                ...
                <table class="table table-bordered mt-2 transfer-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><strong>{{!empty($iuireportData->sperm_count_pre) ? $iuireportData->sperm_count_pre : '-'}}</strong></td>
                            <td><strong>{{!empty($iuireportData->sperm_count_post) ? $iuireportData->sperm_count_post : '-'}}</strong></td>
                        </tr>
                        <tr>
                            <td>Total Count(mill) :</strong></td>
                            <td><strong>{{!empty($iuireportData->total_count_pre) ? $iuireportData->total_count_pre : '-'}}</strong></td>
                            <td><strong>{{!empty($iuireportData->total_count_post) ? $iuireportData->total_count_post : '-'}}</strong></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><strong>{{!empty($iuireportData->pus_cells_pre) ? $iuireportData->pus_cells_pre : '-'}}</strong></td>
                            <td><strong>{{!empty($iuireportData->pus_cells_post) ? $iuireportData->pus_cells_post : '-'}}</strong></td>
                        </tr>
                    </tbody>
                </table>
