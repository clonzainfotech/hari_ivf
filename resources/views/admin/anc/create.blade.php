                                ...
                                <div id="obstratics_history" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row child-data-parent d-none">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="radio is-conceived">
                                                    ...
                                                    {{Form::radio("p_obstratics[child][child_data][1][child_type]",'twins','',['id'=>'child_type_twins'])}}
                                                    <label for="child_type_twins">
                                                        Twins
                                                    </label>
                                                    {{Form::radio("p_obstratics[child][child_data][1][child_type]",'triple','',['id'=>'child_type_triple'])}}
                                            ...
                                            <div class="col-sm-2">
                                                {{Form::select("p_obstratics[child][child_data][1][ho_gender][]",['male'=>'Male','female'=>'Female'],'',['class'=>'form-control','data-id'=>'','multiple','title'=>'Select Child Gender'])}}
                                                {{-- <div class="radio is-conceived">
                                        ...
                                        <div class="row child-data-parent d-none">
                                            ...
                                            <div class="col-sm-2 expired-reason-1 d-none">
                                                <div class="form-group">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-2">
                                                <div class="input-group">
                                                    ...
                                                    {{Form::number("p_obstratics[ectopic_no]",'0',['class'=>'form-control ectopic-no','min'=>'1','max'=>'12','onwheel'=>"this.blur()"])}}
                                                </div>
                                        ...
                                        <div class="row ectopic-data-parent d-none">
                                            ...
                                            <div class="row col-md-8 ectopic-visible-1">
                                                <div class="col-sm-3">
                                                    <div class="radio is-conceived">
                                                        {{Form::radio("p_obstratics[ectopic][ectopic_data][1][spontancous_ectopic_type]",'medically','',['id'=>'spontancous_ectopic_medically'])}}
                                                        <label for="spontancous_ectopic_medically">
                                                            Medically
                                                        </label>
                                                        {{Form::radio("p_obstratics[ectopic][ectopic_data][1][spontancous_ectopic_type]",'surgically','',['id'=>'spontancous_ectopic_surgically'])}}
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">Before &nbsp;</span>
                                                        {{Form::text("p_obstratics[ectopic][ectopic_data][1][spontancous_ectopic_before]",'',['class'=>'form-control'])}}
                                                    </div>
                                                </div>
                                                <div class="col-sm-2">
                                                    <div class="checkbox">
                                                        {{Form::checkbox('p_obstratics[ectopic][ectopic_data][1][tube][]','right','',['id'=>'right_tube_1'])}}
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="checkbox">
                                                        {{Form::checkbox('p_obstratics[ectopic][ectopic_data][1][tube][]','left','',['id'=>'left_tube_1'])}}
                                        ...
                                        <div class="row ectopic-data-parent d-none">
                                            ...
                                            <div class="col-md-4 ectopic-naturally d-none">
                                                <div class="form-group">
                                                    {{Form::select("p_obstratics[ectopic][ectopic_data][1][ho_type]",['1'=>'Naturally','2'=>'Medicine','3'=>'IUI','4'=>'IVF'],'',['class'=>'form-control select-padding-0 ectopic-ho-type p-ho-type','data-id'=>'ectopic-when-where-1','placeholder'=>'Select Conceived By'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-4 d-none ectopic-when-where-1 when-where-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon">When / Where : &nbsp;</span>
                                                    {{Form::text("p_obstratics[ectopic][ectopic_data][1][when_where]",'',['class'=>'form-control'])}}
                                                </div>
                                            </div>
                                            <div class='col-md-4'>
                                                <div class='input-group'>
                                                    <span class='input-group-addon'>Ectopic Detail : &nbsp;</span>
                                                    {{Form::text("p_obstratics[ectopic][ectopic_data][1][detail]",'',['class'=>'form-control'])}}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row second-marriage-life-data second-child-data-parent d-none">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="radio is-conceived">
                                                    ...
                                                    {{Form::radio("p_obstratics[second_marriage][child][child_data][1][child_type]",'twins','',['id'=>'child_type_twins'])}}
                                                    <label for="child_type_twins">
                                                        Twins
                                                    </label>
                                                    {{Form::radio("p_obstratics[second_marriage][child][child_data][1][child_type]",'triple','',['id'=>'child_type_triple'])}}
                                                    <label for="child_type_triple">
                                                        Triple
                                                    </label>
                                                </div>
                                            ...
                                            <div class="col-sm-2">
                                                {{Form::select("p_obstratics[second_marriage][child][child_data][1][ho_gender][]",['male'=>'Male','female'=>'Female'],'',['class'=>'form-control ','data-id'=>'','multiple','title'=>'Select Child Gender'])}}
                                                {{-- <div class="radio is-conceived">
                                                    {{Form::radio("p_obstratics[child][child_data][1][ho_gender]",'male','',['id'=>'ho_male'])}}
                                                    <label for="ho_male">
                                                        Male
                                        ...
                                        <div class="row second-marriage-life mt-3 d-none">
                                            <div class="col-md-2">
                                                <div class="input-group">
                                                    <span class="input-group-addon">Ectopic : &nbsp;</span>
                                                    {{Form::number("p_obstratics[second_marriage][ectopic_no]",'0',['class'=>'form-control second-ectopic-no','min'=>'1','max'=>'12','onwheel'=>"this.blur()"])}}
                                                </div>
                                        ...
                                        <div class="row second-marriage-life-data second-ectopic-data-parent d-none">
                                            ...
                                            <div class="row col-md-8 second-ectopic-visible-1">
                                                <div class="col-sm-3">
                                                    <div class="radio is-conceived">
                                                        {{Form::radio("p_obstratics[second_marriage][ectopic][ectopic_data][1][spontancous_ectopic_type]",'medically','',['id'=>'second_spontancous_ectopic_medically'])}}
                                                        <label for="second_spontancous_ectopic_medically">
                                                            Medically
                                                        </label>
                                                        {{Form::radio("p_obstratics[second_marriage][ectopic][ectopic_data][1][spontancous_ectopic_type]",'surgically','',['id'=>'second_spontancous_ectopic_surgically'])}}
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">Before &nbsp;</span>
                                                        {{Form::text("p_obstratics[second_marriage][ectopic][ectopic_data][1][spontancous_ectopic_before]",'',['class'=>'form-control'])}}
                                                    </div>
                                                </div>
                                                <div class="col-sm-2">
                                                    <div class="checkbox">
                                                        {{Form::checkbox('p_obstratics[second_marriage][ectopic][ectopic_data][1][tube][]','right','',['id'=>'second_right_tube_1'])}}
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="checkbox">
                                                        {{Form::checkbox('p_obstratics[second_marriage][ectopic][ectopic_data][1][tube][]','left','',['id'=>'second_left_tube_1'])}}
                                        ...
                                        <div class="row second-marriage-life-data second-ectopic-data-parent d-none">
                                            ...
                                            <div class="col-md-4 second-ectopic-naturally d-none">
                                                <div class="form-group">
                                                    {{Form::select("p_obstratics[second_marriage][ectopic][ectopic_data][1][ho_type]",['1'=>'Naturally','2'=>'Medicine','3'=>'IUI','4'=>'IVF'],'',['class'=>'form-control select-padding-0 second-ectopic-ho-type p-ho-type','data-id'=>'second-ectopic-when-where-1','placeholder'=>'Select Conceived By'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-4 d-none ectopic-when-where-1 when-where-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon">When / Where : &nbsp;</span>
                                                    {{Form::text("p_obstratics[second_marriage][ectopic][ectopic_data][1][when_where]",'',['class'=>'form-control'])}}
                                                </div>
                                            </div>
                                            <div class='col-md-4'>
                                                <div class='input-group'>
                                                    <span class='input-group-addon'>Ectopic Detail : &nbsp;</span>
                                                    {{Form::text("p_obstratics[second_marriage][ectopic][ectopic_data][1][detail]",'',['class'=>'form-control'])}}
                                                </div>
                                            </div>
                                        </div>
