                ...
                <div class="body">
                    ...
                    <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    {{Form::select('role',[1=>'Main Admin',2=>'Reception',3=>'Doctor',4=>'Accountant',5=>'Medical',6=>'IVF',7=>'IUI',8=>'ANC'],'',['class'=>'form-control select-padding-0 user-role','placeholder'=>'Select Role'])}}
                                </div>
                            </div>
                        </div>
                    <!-- Tab panes -->
