    ...
    <div class="watermark">
        <table class="table m-b-0 table-hover review-table" id="review-table" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    <td><span class="candor-color font-bold">Type Of Infertility : </span>{{!empty($o_h->type_of_infertility) ? $typeOfData[$o_h->type_of_infertility] : 'Primary'}} / {{!empty($o_h->second_marriage_details) ? $o_h->second_marriage_details.' years' : (!empty($o_h->first_marriage_life) ? $o_h->first_marriage_life.' years' : null)}}</td>
                </tr>
                <tr>
