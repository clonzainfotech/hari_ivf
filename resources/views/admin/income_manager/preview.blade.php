            ...
            <table class="deposit-data deposit" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    {{-- @if($hormon->charge_type == 1) --}}
                        <tr>
                            <td>Category : <b>{{$income->getExpenseCategory->name}}</b></td>
                        </tr>
                <tr>
                    <td>Payment Type: {{!empty($income->payment_method) ? $pMethod[$income->payment_method] : null}}</td>
                </tr>
                <tr>
                    <td><h4>Received With Thanks From</h4></td>
                </tr>
                <tr>
                    <td class="text-center deposit-patient-name"><h3>{{ucwords(strtolower($income->given_by))}}</h3></td>
                    <td></td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td class="text-center"><h3>{{$income->amount}}</h3></td>
                </tr>
                <tr>
