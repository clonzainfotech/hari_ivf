...
@section('parentPageTitle', 'Referance Doctor Pro')
@section('title', 'Referance Doctor Pro')
        ...
        <div class="card">
            <div class="header">
                ...
                <ul class="header-dropdown">
                    <li>
                        <a href="{{URL::to('reference-doctor-pro/create')}}">
                    ...
                    <li>
                        <a href="javascript:void(0);">
                            <button class="btn btn-primary print-reference-doctor">
                                Print
                            </button>
                        </a>
                    </li>
...
@section('page-script')
    <script type="text/javascript">
        ...
        $(document).ready(function(){
           ...
           $(document).on('dblclick', '#Reference-table tbody tr', function(event) {
                ...
                if(typeof(referenceDoctorId) !== 'undefined'){
                    var url = 'reference-doctor-pro/'+referenceDoctorId+'/edit';
        ...
        function getReferenceDoctorData(qstring){
            ...
            $.ajax({
                url: "{{URL::to('reference-doctor-pro')}}?"+qstring,
                dataType: 'json',
            }).done(function(data) {
                if(data.status == 1){
        ...
        function removeReferanceDoctor(){
            $.ajax({
                url: "{{URL::to('reference-doctor-pro/delete/')}}"+'/'+referanceDoctorId,
                dataType: 'json',
            }).done(function(data) {
                getReferenceDoctorData(qstring);
            }).fail(function() {
